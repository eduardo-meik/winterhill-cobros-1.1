      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          ...
          <div className="grid md:grid-cols-3 gap-4">
            ...
            <div><label className="block text-xs mb-1 font-medium">Día Vencimiento (1-10)</label><input type="number" min={1} max={28} className="w-full border rounded px-2 py-1" value={schedule.dia_vencimiento} onChange={e=> setSchedule({...schedule,dia_vencimiento:e.target.value})} /></div>
          </div>
