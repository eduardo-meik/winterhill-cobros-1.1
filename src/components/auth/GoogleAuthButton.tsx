...
export function GoogleAuthButton({ 
  ...
  if (!googleClientId) {
    ...
    // In production, show a disabled button with message
    return (
      <button
        type="button"
        disabled={true}
        className="w-full inline-flex justify-center items-center px-4 py-2 border border-gray-300 rounded-md shadow-sm bg-gray-100 text-sm font-medium text-gray-400 cursor-not-allowed"
      >
        <svg 
