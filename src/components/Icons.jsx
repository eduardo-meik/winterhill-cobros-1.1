...
export const BoxArrowInUpRight = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-box-arrow-in-up-right" viewBox="0 0 16 16">
    <path fillRule="evenodd" d="M6.364 13.5a.5.5 0 0 0 0-1H2.5A1.5 1.5 0 0 1 1 11V2.5A1.5 1.5 0 0 1 2.5 1h8.5A1.5 1.5 0 0 1 12.5 2.5v3.864a.5.5 0 0 0 1 0V2.5A2.5 2.5 0 0 0 11 0H2.5A2.5 2.5 0 0 0 0 2.5V11a2.5 2.5 0 0 0 2.5 2.5z" />
    <path fillRule="evenodd" d="M11.5 8a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h4a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5z" />
    <path fillRule="evenodd" d="M16 0.5a.5.5 0 0 0-.5-.5h-5a.5.5 0 0 0 0 1h3.793L6.146 9.146a.5.5 0 1 0 .708.708L15 1.707V5.5a.5.5 0 0 0 1 0z" />
  </svg>
);
