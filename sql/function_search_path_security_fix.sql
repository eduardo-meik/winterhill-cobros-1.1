...
-- Generic updated_at triggers (using actual table names from schema)
-- Create triggers for tables that exist and have updated_at columns
DO $$
DECLARE
    table_name text;
...
-- Run these to verify the functions have been updated correctly:
-- 
-- SELECT 
