-- ============================================================================
-- ELIMINAR ESTUDIANTES DE PRUEBA - VERSIÓN CORREGIDA
-- Created: 2025-12-22
-- Schema validado contra Public_Schema_Column_Inventory.json
-- ============================================================================
...
-- 3.1 Eliminar documentos de matrícula
...
-- 3.8 Eliminar matrículas huérfanas
