...
-- enrollment_id: 0fd48c9a-ea48-406e-96ae-a08e633b689b | folio: ENR-2026-000326 | filas CSV: 29, 30
-- alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-01', 'Banco de Chile', '2026-03-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 1, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
    and c.numero_cuota = 1
);

insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-02', 'Banco de Chile', '2026-04-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 2, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-03', 'Banco de Chile', '2026-05-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 3, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-04', 'Banco de Chile', '2026-06-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 4, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-05', 'Banco de Chile', '2026-07-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 5, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-06', 'Banco de Chile', '2026-08-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 6, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-07', 'Banco de Chile', '2026-09-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 7, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-08', 'Banco de Chile', '2026-10-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 8, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-09', 'Banco de Chile', '2026-11-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 9, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid, 'PEND-ENR2026000326-10', 'Banco de Chile', '2026-12-05'::date, 266252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 29, 30; alumnos: DANAE AMELIE CARVAJAL GUTIERREZ | LEONARDO MANUEL CARVAJAL GUTIERREZ; series_csv: 2124264-257-258-259-260-261-2632072834-35-36-; parse_mode: placeholder; issues: series_count_mismatch:9->10, placeholder_serials_generated', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 10, 'ENR-2026-000326'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '0fd48c9a-ea48-406e-96ae-a08e633b689b'::uuid
...
-- enrollment_id: 626d645e-351b-4860-b9ae-1ec51e296686 | folio: ENR-2026-000365 | filas CSV: 23, 24, 25
-- alumnos: DANTE LEON ARENAS LANDEROS | ELOÍSA IZADI ARENAS LANDEROS | OCTAVIO ANDRES ARENAS LANDEROS
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '626d645e-351b-4860-b9ae-1ec51e296686'::uuid, '3662644', 'Banco de Chile', '2026-03-05'::date, 651107, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 23, 24, 25; alumnos: DANTE LEON ARENAS LANDEROS | ELOÍSA IZADI ARENAS LANDEROS | OCTAVIO ANDRES ARENAS LANDEROS; series_csv: 3662644-45-46-47-48; parse_mode: parsed_basic', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 1, 'ENR-2026-000365'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '626d645e-351b-4860-b9ae-1ec51e296686'::uuid
    and c.numero_cuota = 1
);

insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '626d645e-351b-4860-b9ae-1ec51e296686'::uuid, '3662645', 'Banco de Chile', '2026-04-05'::date, 651107, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 23, 24, 25; alumnos: DANTE LEON ARENAS LANDEROS | ELOÍSA IZADI ARENAS LANDEROS | OCTAVIO ANDRES ARENAS LANDEROS; series_csv: 3662644-45-46-47-48; parse_mode: parsed_basic', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 2, 'ENR-2026-000365'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '626d645e-351b-4860-b9ae-1ec51e296686'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '626d645e-351b-4860-b9ae-1ec51e296686'::uuid, '3662646', 'Banco de Chile', '2026-05-05'::date, 651107, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 23, 24, 25; alumnos: DANTE LEON ARENAS LANDEROS | ELOÍSA IZADI ARENAS LANDEROS | OCTAVIO ANDRES ARENAS LANDEROS; series_csv: 3662644-45-46-47-48; parse_mode: parsed_basic', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 3, 'ENR-2026-000365'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '626d645e-351b-4860-b9ae-1ec51e296686'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '626d645e-351b-4860-b9ae-1ec51e296686'::uuid, '3662647', 'Banco de Chile', '2026-06-05'::date, 651107, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 23, 24, 25; alumnos: DANTE LEON ARENAS LANDEROS | ELOÍSA IZADI ARENAS LANDEROS | OCTAVIO ANDRES ARENAS LANDEROS; series_csv: 3662644-45-46-47-48; parse_mode: parsed_basic', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 4, 'ENR-2026-000365'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '626d645e-351b-4860-b9ae-1ec51e296686'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '626d645e-351b-4860-b9ae-1ec51e296686'::uuid, '3662648', 'Banco de Chile', '2026-07-05'::date, 651107, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 23, 24, 25; alumnos: DANTE LEON ARENAS LANDEROS | ELOÍSA IZADI ARENAS LANDEROS | OCTAVIO ANDRES ARENAS LANDEROS; series_csv: 3662644-45-46-47-48; parse_mode: parsed_basic', 'cca2d2ee-dffd-4ba2-9e87-0825730e00ce'::uuid, 5, 'ENR-2026-000365'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '626d645e-351b-4860-b9ae-1ec51e296686'::uuid
...
-- enrollment_id: 6599447f-fd35-4d28-99dd-888c99ee2a62 | folio: ENR-2026-000239 | filas CSV: 44
-- alumnos: MATIAS ANKATU CASTRO CORREA
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '6599447f-fd35-4d28-99dd-888c99ee2a62'::uuid, 'PEND-ENR2026000239-01', 'Santander', '2026-03-05'::date, 1334760, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 44; alumnos: MATIAS ANKATU CASTRO CORREA; series_csv: solo un cheque; parse_mode: placeholder; issues: series_without_digits, placeholder_serials_generated', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 1, 'ENR-2026-000239'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '6599447f-fd35-4d28-99dd-888c99ee2a62'::uuid
    and c.numero_cuota = 1
);
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963497', 'ItaÃº', '2026-04-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 2, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963506', 'ItaÃº', '2026-05-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 3, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963499', 'ItaÃº', '2026-06-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 4, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963500', 'ItaÃº', '2026-07-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 5, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963501', 'ItaÃº', '2026-08-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 6, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963502', 'ItaÃº', '2026-09-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 7, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963503', 'ItaÃº', '2026-10-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 8, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963504', 'ItaÃº', '2026-11-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 9, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid, '6963505', 'ItaÃº', '2026-12-05'::date, 273252, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 31, 32; alumnos: DANIEL ERNESTO CONEJEROS BELTRAMI | JAVIERA VIOLETA CONEJEROS BELTRAMI; series_csv: 6963496-97-506-499-500-501-502-503-504-505; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 10, 'ENR-2026-000421'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = '949f452f-c039-4da0-ac5a-0afa3658b058'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814144', 'ItaÃº', '2026-04-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 2, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814145', 'ItaÃº', '2026-05-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 3, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814146', 'ItaÃº', '2026-06-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 4, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814147', 'ItaÃº', '2026-07-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 5, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814148', 'ItaÃº', '2026-08-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 6, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814149', 'ItaÃº', '2026-09-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 7, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814150', 'ItaÃº', '2026-10-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 8, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814141', 'ItaÃº', '2026-11-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 9, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid, '2814142', 'ItaÃº', '2026-12-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 50; alumnos: SIMON EMILIO LAZCANO MALDONADO; series_csv: 2814143-4-5-6-7-8-9-150-1-2; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 10, 'ENR-2026-000198'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'a392bde7-871d-44ed-b57f-5180fddb97a1'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460238', 'ItaÃº', '2026-04-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 2, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460239', 'ItaÃº', '2026-05-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 3, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460240', 'ItaÃº', '2026-06-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 4, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460241', 'ItaÃº', '2026-07-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 5, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460242', 'ItaÃº', '2026-08-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 6, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460243', 'ItaÃº', '2026-09-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 7, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460244', 'ItaÃº', '2026-10-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 8, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
...
insert into public.cheques (enrollment_id, numero_serie, banco, fecha_emision, monto, estado, notas, created_by, numero_cuota, folio_number)
select 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid, '3460246', 'ItaÃº', '2026-12-05'::date, 102870, 'pendiente', 'Carga inicial desde update_cheques.csv fila(s) 11; alumnos: AYLIN MAITE ELOISA ALARCON OYARZUN; series_csv: 3460237-38-39-40-41-42-43-44-45-46; parse_mode: parsed_basic', '23daf698-8cfb-4697-ad90-1966c4e4de0a'::uuid, 10, 'ENR-2026-000410'
where not exists (
  select 1
  from public.cheques c
  where c.enrollment_id = 'd83a358c-b4fe-4191-8ec2-54c990b95ca8'::uuid
